...
// static void			check_cylinder_obj3(t_env *env, t_buff line, int i)
// {
// 	t_double3	values;
...
// 			add_cylinder_value(env, &values, i);
// 		}
// 		else
...
// static void			check_cylinder_obj2(t_env *env, t_buff line, int i)
// {
// 	t_double3	values;
...
// 			ft_error("Error : Wrong Value Name.\n");
// 	}
// 	check_cylinder_obj3(env, line, i);
// }
...
// 			ft_error("Error : Wrong Value Name.\n");
// 	}
// 	check_cylinder_obj2(env, line, i);
// }
